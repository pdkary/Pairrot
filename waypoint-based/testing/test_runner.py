...
def test_narrow_zig_zag_noiseless():
    ...
    f.follow(50)
    f.set_rtl()
    f.write_to_csv("zz_noiseless_2.csv")
    f.vehicle.close()
...
def test_wide_zig_zag_noiseless():
    ...
    f.follow(50)
    f.set_rtl()
    f.write_to_csv("zz_noiseless_10.csv") 
    f.vehicle.close()
...
def test_wide_zig_zag_noisy():
    ...
    f.follow(50)
    f.set_rtl()
    f.write_to_csv("zz_noisy_10.csv")
    f.vehicle.close()
...
def test_small_circle_noiseless():
    ...
    f.follow(50)
    f.set_rtl()
    f.write_to_csv("circle_noiseless_1.csv")
    f.vehicle.close()
...
def test_small_circle_noisy():
    ...
    f.follow(50)
    f.set_rtl()
    f.write_to_csv("circle_noisy_1.csv")
    f.vehicle.close()
...
def test_wide_circle_noiseless():
    ...
    f.follow(50)
    f.set_rtl()
    f.write_to_csv("circle_noiseless_5.csv")
    f.vehicle.close()
...
def test_wide_circle_noisy():
    ...
    f.follow(50)
    f.set_rtl()
    f.write_to_csv("circle_noisy_5.csv")
    f.vehicle.close()
